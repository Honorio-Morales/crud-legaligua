		...
		<div class="card">
			...
			<div class="card-content">
				...
				<div class="input-field">
					<input id="vs1" type="text" title="Sumando 01" name="vs1" required autofocus="Ingrese Numeros">
					<label for="vs1">Sumando 01:</label>
				</div>
				<div class="input-field">
					<input id="vs2" type="text" title="Sumando 02" name="vs2" required autofocus="Ingrese Numeros">
					<label for="vs2">Sumando 02:</label>
				</div>
				<p><button type="submit" class="btn black" id="mostrar">Sumar<i class="material-icons" >add</i></button></p>
				<!--</form>-->
			</div>
			<div class="card">
				<div class="card-content #e0f7fa cyan lighten-5">
