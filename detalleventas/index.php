...
<!--pagina principal--> <div class="row">
<div class="col s12">
	<div class="card">
		<div class="card-content #e0f7fa cyan lighten-5">
			<center><span class="card-title">DETALLE VENTAS</span></center>
				...
				<div class="input-field">
					<input type="text" name="idProducto" required autofocus title="DEBE DE CONTENER ENTRE 8 Y
					15 CARACTERES, SOLO LETRAS" pattern="[A-Za-z](8,15)" id="idProducto" onblur="may(this.value,
					this.id)">
					<label for="idProducto">Detalle Venta:</label>
				</div>
